...
local function upgrade_timer(pos)
	...
	if expansion1:get_name()== "cryptocoins:game_computer_video" then
	...
	if expansion2:get_name()=="cryptocoins:game_computer_video" then
		upgraded_miner = upgraded_miner - game_upgrade_step
	else
	...
	if expansion3:get_name()== "cryptocoins:game_computer_video" then
		upgraded_miner = upgraded_miner - game_upgrade_step
	else
...
function default.game_off_formspec(pos)
	local formspec = "invsize[10,10]"..
		"background[1,2.5;8,7;cryptocoins_game_computer_motherboard.png]"..
...
function default.game_off(pos)
	...
	local inv = meta:get_inventory()
	minetest.swap_node(pos, {name = 'cryptocoins:game_computer', param2 = node.param2})
...
-- Game Computer
minetest.register_node("cryptocoins:game_computer",{
	drawtype = "nodebox",
	description = "Game Computer",
	tiles = {"cryptocoins_game_computer_tp.png","cryptocoins_game_computer_bt.png","cryptocoins_game_computer_rt.png","cryptocoins_game_computer_lt.png","cryptocoins_game_computer_bk.png","cryptocoins_game_computer_ft_off.png"},
	paramtype = "light",
	paramtype2 = "facedir",
	drop = "cryptocoins:game_computer",
		...
		if isp == nil then
			...
			if wifi == nil then
				...
				if ( minetest.get_player_by_name(meta:get_string("owner")) == nil ) then
					...
					local node = minetest.get_node(pos)
					local inv = meta:get_inventory()
					minetest.swap_node(pos, {name = 'cryptocoins:game_computer_active', param2 = node.param2})
...
minetest.register_node("cryptocoins:game_computer_active",{
	drawtype = "nodebox",
	description = "Game Computer",
	tiles = {"cryptocoins_game_computer_tp.png","cryptocoins_game_computer_bt.png","cryptocoins_game_computer_rt.png","cryptocoins_game_computer_lt.png","cryptocoins_game_computer_bk.png","cryptocoins_game_computer_ft.png"},
	paramtype = "light",
	paramtype2 = "facedir",
	light_source = 8,
	drop = "cryptocoins:game_computer",
