...
local function upgrade_timer(pos)
	...
	if expansion1:get_name()== "cryptocoins:home_computer_video" then
	...
	if expansion2:get_name()=="cryptocoins:home_computer_video" then
		upgraded_miner = upgraded_miner - home_upgrade_step
	else
	...
	if expansion3:get_name()== "cryptocoins:home_computer_video" then
		upgraded_miner = upgraded_miner - home_upgrade_step
	else
...
function default.home_off_formspec(pos)
	local formspec = "invsize[10,10]"..
		"background[1,2.5;8,7;cryptocoins_home_computer_motherboard.png]"..
...
function default.home_off(pos)
	...
	local inv = meta:get_inventory()
	minetest.swap_node(pos, {name = 'cryptocoins:home_computer', param2 = node.param2})
...
-- Home Computer
minetest.register_node("cryptocoins:home_computer",{
	drawtype = "nodebox",
	description = "Home Computer",
	tiles = {"cryptocoins_home_computer_tp.png","cryptocoins_home_computer_bt.png","cryptocoins_home_computer_rt.png","cryptocoins_home_computer_lt.png","cryptocoins_home_computer_bk.png","cryptocoins_home_computer_ft_off.png"},
	paramtype = "light",
	paramtype2 = "facedir",
	drop = "cryptocoins:home_computer",
		...
		if isp == nil then
			...
			if wifi == nil then
				...
				if ( minetest.get_player_by_name(meta:get_string("owner")) == nil ) then
					...
					local node = minetest.get_node(pos)
					local inv = meta:get_inventory()
					minetest.swap_node(pos, {name = 'cryptocoins:home_computer_active', param2 = node.param2})
...
minetest.register_node("cryptocoins:home_computer_active",{
	drawtype = "nodebox",
	description = "Home Computer",
	tiles = {"cryptocoins_home_computer_tp.png","cryptocoins_home_computer_bt.png","cryptocoins_home_computer_rt.png","cryptocoins_home_computer_lt.png","cryptocoins_home_computer_bk.png","cryptocoins_home_computer_ft.png"},
	paramtype = "light",
	paramtype2 = "facedir",
	light_source = 8,
	drop = "cryptocoins:home_computer",
